...
class TopBar extends Component {
  ...
  render() {
    const { filename, isUnsaved } = this.props
    ...
    const fileButtons = isOnline
      ...
      : (
        <div>
        {/*<p style={{color:'orange',fontStyle:'italic', float: 'left',fontSize: 20}}>Lưu ý: Phải edit xong hết mới bấm Save</p>
        <Button
          style={ styles.button }
    ...
    return (
      <div style={{ height: 32, display: 'flex' }}>
        <h1 style={{ marginLeft: 8, marginTop: 0, color:'red' }}>
          DỮ LIỆU CHƯA ĐƯỢC EDIT (STATUS=1)
        </h1>
