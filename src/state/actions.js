...
export const CORRECT_EXAMPLE = 'CORRECT_EXAMPLE'
export const alreadyCorrect = (id: string, example: Object): Function =>  async (
  dispatch: Function
): Promise<void> => {


  const response = await fetch(`${ROOT_PATH}alreadyCorrect`, {
    method: 'POST',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json',
...
export const COMPLETE_EXAMPLE = 'COMPLETE_EXAMPLE'
export const completeEdit = (id: string, example: Object): Function =>  async (
  dispatch: Function
): Promise<void> => {


  const response = await fetch(`${ROOT_PATH}completeEdit`, {
    method: 'POST',
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json',
